    ...
    <section id="hakkimda" className="py-24 bg-white relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <RevealOnScroll direction="right" width="100%" delay={0.2}>
            <div className="space-y-8">
              ...
              <div className="space-y-4 text-gray-600 font-light leading-relaxed text-lg text-justify">
                <p>
                  ...
                  mezun olan Av. Aleyna Öçgün, meslek hayatına başladığı günden
                  bu yana Ceza Hukuku ve Aile Hukuku alanlarında uzmanlaşmıştır.
                </p>
                <p>
                  ...
                  yönetilebilir kılıyor, sonuca odaklı stratejiler
                  geliştiriyoruz.
                </p>
              </div>

              {/* Eğitim Bilgileri (Aynı kaldı, kod kısaltıldı) */}
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 pt-4">
                {/* ... Buradaki kodlar orijinal halindeki gibi kalacak ... */}
