...
export default function FaqSection() {
  ...
  return (
    <section className="py-20 bg-surface-light" id="faq">
      <div className="max-w-3xl mx-auto px-4">
        ...
        <div className="space-y-4">
          {faqs.map((faq, index) => (
            <div
              key={index}
              className="border border-primary/10 rounded-sm bg-white overflow-hidden"
            >
              <button
              ...
              >
                <p className="text-gray-500 font-light text-sm">{faq.answer}</p>
              </div>
            </div>
          ))}
        </div>
